      ...
      <div class="bg-white shadow" style="padding: 35px;">
        <div class="row g-2">
          <div class="col-md-10">
            <div class="row">
              <div class="col-md-12">
                <input type="text" class="form-control ip-search" name="" placeholder="Enter the name of the hotel you want to find">
              </div>
            </div>
            <div class="row g-2">
              <div class="col-md-3">
          ...
          <div class="room-item shadow rounded overflow-hidden">
            ...
            <div class="p-4 mt-2">
              ...
              <div class="d-flex justify-content-between">
                <a class="btn btn-sm btn-primary rounded py-2 px-4" href="room-detail.jsp">View Detail</a>
